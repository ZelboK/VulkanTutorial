...
{
	auto vertShaderCode = FileUtil::readFile("shaders/vert.spv");
	auto fragShaderCode = FileUtil::readFile("shaders/frag.spv");
...
void TriangleApplication::recordCommandBuffer(VkCommandBuffer commandBuffer,
	uint32_t imageIndex)
{
